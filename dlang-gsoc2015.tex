...
2015 Google Summer of Code for Digital Mars, which is the orgnaization
...
language, to patch a few remaining holes in the standard library, and to m
ake the language more attractive to those currently outside the 
community.  
...
In order to deal with students who dissappear or who fail to
maintain a suitable level of progress in their projects we plan
to do following:

\begin{enumerate}
\item Careful monitoring to avoid such situations, have agreed upon
schedule.
...
but the adminstrator will follow up regularly with the mentors, and
